...
CREATE TABLE IF NOT EXISTS application.employees (
    ...
    CONSTRAINT team_id_fk FOREIGN KEY (team) REFERENCES application.teams (id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE NOT VALID,
    CONSTRAINT title_id_fk FOREIGN KEY (title_id) REFERENCES application.titles (id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE NOT VALID
) TABLESPACE pg_default;

ALTER TABLE
    IF EXISTS application.employees OWNER to "Femi";
...
ALTER TABLE
    IF EXISTS application.projects OWNER to "Femi";
...
CREATE TABLE IF NOT EXISTS application.team_project (
    ...
    CONSTRAINT project_id_fk FOREIGN KEY (project_id) REFERENCES application.projects (id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE,
    CONSTRAINT team_id_fk FOREIGN KEY (team_id) REFERENCES application.teams (id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE CASCADE NOT VALID
) TABLESPACE pg_default;

ALTER TABLE
    IF EXISTS application.team_project OWNER to "Femi";
...
ALTER TABLE
    IF EXISTS application.teams OWNER to "Femi";
...
ALTER TABLE
    IF EXISTS application.titles OWNER to "Femi";